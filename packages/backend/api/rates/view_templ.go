...
func Search(res TableResponse) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, item := range res.Results {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 5, "</span><div class=\"flex flex-row justify-center gap-2\"><svg data-flag=\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 6, "\" x-bind:data-src=\"flags.get($el.getAttribute(&#39;data-flag&#39;))\" data-cache=\"21600\" class=\"h-6 w-8\"></svg><div class=\"w-8\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
